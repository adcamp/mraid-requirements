...
- [Технические требования](#requirments)
  ...
  - [Пользовательские события и статистика](#req6)
...
***
#### <a name="req6"></a> Пользовательские события и статистика

Основные события уже интегрированы в статистику и учитываются автоматически: 
- click (нажатие на целевую ссылку)
- close (закрытие баннера)
- expand (расхлоп баннера)
- colapse (сворачивание баннера)

Метод mraid.eventEmitter(), установленный в код креатива, позволяет отправлять в статистику собственные события, указанные в его аргументе:
- videoStart (начало видео)
- videoEnd (конец видео)
- user1 (кастомное событие)

**Пример:**
```
$click_button.addEventListener('click', function(){
  videoPlay();
  mraid.eventEmitter('videoStart');
});
```
